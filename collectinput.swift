...
//  extension.swift
//  ThemparatureConverter
//
//  Created by Mo Asche on 2021-02-02.
//
...
extension Double {
    ...
    static func collectInput(withPrompt prompt: String, minimum: Int?, maximum: Double?) -> Double {
        ...
        while true {
            ...
            if let minimumValue = minimum {
                ...
                // ... then check that the given integer is greater than or equal to the lowest desired value.
                guard Int(givenDouble) >= minimumValue else {
                    continue
                }
